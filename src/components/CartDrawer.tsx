      ...
      >
        <div className="p-10 border-b border-editor-border flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <h2 className="font-serif text-3xl font-light italic">The Archive</h2>
          </div>
        ...
        <div className="flex-1 overflow-y-auto p-10 flex flex-col gap-10">
          {items.length === 0 ? (
            <div className="flex flex-col items-center justify-center h-full text-center gap-6">
              <span className="text-[10px] tracking-widest uppercase opacity-40">Collection is currently empty</span>
              <button 
                onClick={onClose}
              ...
              <div key={item.id} className="flex gap-8 group">
                ...
                <div className="flex flex-col flex-1">
                  ...
                  <div className="mt-auto flex justify-between items-end">
                    ...
                    <span className="text-lg font-light tracking-tighter">${(item.price * item.quantity).toFixed(2)}</span>
                  </div>
                </div>
              </div>
            ))
